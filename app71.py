...
column_names = ['Wiek', 'Poziom edukacji', 'Ulubione zwierzęta', 'Ulubione miejsce', 'Płeć']

# Wyświetlamy dane z nowymi nazwami kolumn
st.header("Szczegóły grupy")
st.dataframe(same_cluster_df[['age', 'edu_level', 'fav_animals', 'fav_place', 'gender']].rename(columns={
    'age': column_names[0],
    'edu_level': column_names[1],
    'fav_animals': column_names[2],
    'fav_place': column_names[3],
    'gender': column_names[4]
}))
